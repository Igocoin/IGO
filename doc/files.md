...
* igocoin.conf: contains configuration settings for igocoind or igocoin-qt
* igocoind.pid: stores the process id of igocoind while running
...
* debug.log: contains debug information and general logging generated by igocoind or igocoin-qt
