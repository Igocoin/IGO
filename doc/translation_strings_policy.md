...
This document provides guidelines for internationalization of the Igocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `igocoin_en.ts` remains unchanged.
