...
1. Clone the Igocoin Core source code and cd into `igocoin`

        git clone https://github.com/igocoin/igocoin
        cd igocoin

2.  Build Igocoin Core:

    Configure and build the headless Igocoin Core binaries as well as the GUI (if Qt is found).
...
Igocoin Core is now available at `./src/igocoind`
...
* Building with downloaded Qt binaries is not officially supported. See the notes in [#7714](https://github.com/igocoin/igocoin/issues/7714)
