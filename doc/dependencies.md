...
These are the dependencies currently used by IGOCOIN. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/igocoinnl
Keybase  - https://keybase.io/team/igocoin/
