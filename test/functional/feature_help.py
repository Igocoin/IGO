...
"""Verify that starting igocoin with -h works as expected."""

from test_framework.test_framework import IgocoinTestFramework
from test_framework.util import assert_equal

class HelpTest(IgocoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start igocoin with -h for help text")
        ...
        self.log.info("Start igocoin with -version for version information")
        ...
        self.log.info("Start igocoind with -fakearg to make sure it does not start")
