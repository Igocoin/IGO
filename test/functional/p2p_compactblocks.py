...
# TestP2PConn: A peer we use to send messages to igocoind, and store responses.
...
class CompactBlocksTest(IgocoinTestFramework):
    ...
    # This test actually causes igocoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that igocoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for igocoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # igocoind will not send blocktxn responses for blocks whose height is
