...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"igocoinaddress\"\n"
            "\nReveals the private key corresponding to 'igocoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"igocoinaddress\"   (string, required) The igocoin address for the private key\n"
            "\nResult:\n"
