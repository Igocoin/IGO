...
static void SetupIgocoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " igocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  igocoin-tx [options] <hex-tx> [commands]  Update hex-encoded igocoin transaction\n" +
            "or:     igocoin-tx [options] -create [commands]   Create hex-encoded igocoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded igocoin transaction
