...
#ifndef IGOCOIN_INTERFACES_NODE_H
#define IGOCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a igocoin node (igocoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // IGOCOIN_INTERFACES_NODE_H
