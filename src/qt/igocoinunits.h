...
#ifndef IGOCOIN_QT_IGOCOINUNITS_H
#define IGOCOIN_QT_IGOCOINUNITS_H
...
/** Igocoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class IgocoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit IgocoinUnits(QObject *parent);

    /** Igocoin units.
      @note Source: https://en.igocoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        IGO,
...
typedef IgocoinUnits::Unit IgocoinUnit;

#endif // IGOCOIN_QT_IGOCOINUNITS_H
