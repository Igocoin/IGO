    ...
    mapper(0)
{
    ...
    ui->igocoinAtStartup->setToolTip(ui->igocoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->igocoinAtStartup->setText(ui->igocoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openIgocoinConfButton->setToolTip(ui->openIgocoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new IgocoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->igocoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openIgocoinConfButton_clicked()
{
