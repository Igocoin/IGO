...
{
    BOOST_CHECK(TestSplitHost("www.igocoincore.org", "www.igocoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.igocoincore.org]", "www.igocoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.igocoincore.org:80", "www.igocoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.igocoincore.org]:80", "www.igocoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:29294", "127.0.0.1", 29294));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:29294", "127.0.0.1", 29294));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:29294", "::ffff:127.0.0.1", 29294));
    BOOST_CHECK(TestSplitHost("[::]:29294", "::", 29294));
    BOOST_CHECK(TestSplitHost("::29294", "::29294", -1));
    BOOST_CHECK(TestSplitHost(":29294", "", 29294));
    BOOST_CHECK(TestSplitHost("[]:29294", "", 29294));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:29294", "127.0.0.1:29294"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:29294", "[::]:29294"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
