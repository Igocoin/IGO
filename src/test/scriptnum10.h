...
#ifndef IGOCOIN_TEST_SCRIPTNUM10_H
#define IGOCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Igocoin Core 0.10.0, for cross-comparison.
 */
public:
