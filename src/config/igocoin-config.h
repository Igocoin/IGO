/* src/config/igocoin-config.h.  Generated from igocoin-config.h.in by configure.  */
/* src/config/igocoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef IGOCOIN_CONFIG_H

#define IGOCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Igocoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Igocoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/igocoin/igocoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Igocoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Igocoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "igocoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://igocoincore.org/"
